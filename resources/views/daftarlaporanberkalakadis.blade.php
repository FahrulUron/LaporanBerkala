                ...
                <tbody class="bg-white divide-y divide-gray-100">
                  ...
                  <tr class="border-b dark:border-slate-700">
                    ...
                    <td class="px-4 py-3 text-center">
                      ...
                      @elseif($pengajuan->status === 'disetujui kadis')
                        <a href="/daftarlaporanberkalaevaluator/{{ $pengajuan->id }}" class="inline-flex items-center px-3 py-1.5 text-sm font-medium text-blue-600  rounded-lg hover:bg-blue-100 hover:text-blue-700 transition-colors duration-200">
